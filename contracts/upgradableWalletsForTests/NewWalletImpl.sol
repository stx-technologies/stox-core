...
import "../upgradableWalletsForTests/UpgradableSmartWalletLib.sol";
import "../upgradableWalletsForTests/INewWalletImpl.sol";
import "../predictions/PoolPrediction.sol";

contract NewWalletImpl is INewWalletImpl {
